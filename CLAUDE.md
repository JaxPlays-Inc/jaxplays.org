...
```bash
# Rebuild generated people, credit, production directory, and theatre production indexes after content edits
...
production credits, production metadata, theatre names/aliases, people names, aliases, or show poster fallbacks.
