...
featured_image:
  src: /media/photos/2024-Six.webp
  alt: "The cast of 'Six the Musical' is captured mid-performance, adorned in glittering, Tudor-inspired pop costumes, energetically singing and dancing on a stage set with arched, backlit designs and a live band in the background."
  caption: "The Tudor queens take center stage. The cast of 'Six' dazzles with show-stopping numbers."
  credit:
    name: Joan Marcus
authors:
- Ray Hollister
...
The "Haus of Holbein" and [[person:Terica Marie]]'s performance of "Get Down" offer lighter, yet equally engaging moments. The former serves as a delightful palate cleanser with its German house electronic vibes, while the latter, inspired by Nicki Minaj's hip-hop style, sets the audience alight with energy.
